    ...
    for (let i = 0; i < nodeQueue.length; i++) {
      ...
      try {
        ...
        if (currentNode.type.startsWith('ai-')) {
          addLog('info', `🧠 Invoking Gemini AI model with prompt: "${currentNode.config?.prompt || 'Summarizing...'}"`);
          ...
          addLog('success', `✅ AI Response generated: ${data.message || 'Task completed successfully.'}`);
          ...
          addIssue({
            ...
            title,
            description: `Automated issue generated by n8n workflow "${activeWorkflow.name}"`,
            status: 'Todo',
            type: 'Task',
          ...
          addLog('success', `✅ Node [${currentNode.label}] completed.`);
        }
